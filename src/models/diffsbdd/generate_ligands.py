...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_traj', action='store_true',
                        help='save trajectory for 1 sample')
    parser.add_argument('--timesteps', type=int, default=500)
    args = parser.parse_args()
    
    if args.save_traj and args.n_samples > 1:
        print("Trajectory saving is only supported for n_samples=1. Setting n_samples=1.")
        args.n_samples = 1
    ...
    for i in range(args.n_samples // args.batch_size):
        molecules_batch = model.generate_ligands(
            ...
            timesteps=args.timesteps, save_traj=args.save_traj)
