...
def inpaint_ligand(model, pdb_file, n_samples, ligand, fix_atoms,
    ...
    print(f"Initial ligand_mask device: {ligand_mask.device}")
    ligand_mask = ligand_mask.to(model.device)
    print(f"After moving ligand_mask device: {ligand_mask.device}")
    ...
    print(f"Before final loop - x device: {x.device}")
    print(f"Before final loop - atom_type device: {atom_type.device}")
    print(f"Before final loop - lig_mask device: {lig_mask.device}")
