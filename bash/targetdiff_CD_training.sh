...
#SBATCH --array=0-3
#SBATCH --output=jobs_files/targetdiff_penlogp_CD_%a.log
#SBATCH --error=jobs_files/targetdiff_penlogp_CD_%a.log
...
CHECKPOINT_OUTPUT_DIR="${PROJECT_ROOT}/Log_Results/targetdiff_penlogp_CD"
